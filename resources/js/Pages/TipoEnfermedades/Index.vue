<template>
    <AppLayout title="Gestión de Tipos de Enfermedades">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Gestión de Tipos de Enfermedades</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white p-6 rounded-lg shadow">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="item in enfermedades.data" :key="item.id">
                ...
                <div class="mt-6 flex justify-center gap-2">
                    <button
                        v-for="link in enfermedades.links"
                        :key="link.label"
                        :disabled="!link.url"
...
const search = ref('');
const submitSearch = () => {
    router.get(route('tipo-enfermedades.index'), {
        buscar: search.value,
    }, {
        preserveState: true,
        replace: true,
