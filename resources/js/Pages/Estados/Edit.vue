...
const hasChanges = computed(() => {
    return (
        form.nombre !== props.estado.nombre ||
        form.descripcion !== (props.estado.descripcion || "")
    );
});
...
const submit = () => {
    form.put(route("estados.update", props.estado.id));
};
