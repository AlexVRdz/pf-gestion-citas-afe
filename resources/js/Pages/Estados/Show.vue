<template>
    <AppLayout title="Detalles de Estado de Cita">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Detalles de Estado de Cita
            </h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="px-6 py-4 bg-red-50 border-t border-red-200">
                        ...
                        <p class="text-sm text-red-700 mb-4">
                            Una vez eliminado, este estado de cita no podrá ser
                            recuperado.
                        </p>
                        <button
                            @click="deleteestado"
                            :disabled="
                                deleting ||
                                (estado?.citas && estado.citas.length > 0)
                            "
                        ...
                        >
                            ...
                            <span
                                ...
                                "
                            >
                                No se puede eliminar (tiene citas asociadas)
                            </span>
                            <span v-else>Eliminar Estado de Cita</span>
                        </button>
                    </div>
                </div>
            </div>
...
const deleteestado = () => {
    ...
    if (confirm("¿Estás seguro de eliminar este estado?")) {
        ...
        router.delete(route("estados.destroy", props.estado.id), {
            onFinish: () => {
                deleting.value = false;
            },
            onError: (errors) => {
                console.error("Error eliminando:", errors);
                alert("Error al eliminar el estado de cita");
            },
        });
    }
};
...
onMounted(() => {
    ...
    console.log("Tipo de estado:", props.estado);
